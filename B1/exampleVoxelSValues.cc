...
int main(int argc,char** argv)
{
  ...
  //
  // Stepping action
  runManager->SetUserAction(new VoxelSValuesSteppingAction());     

  // Event action
  runManager->SetUserAction(new VoxelSValuesEventAction());

  // Run action
  runManager->SetUserAction(new VoxelSValuesRunAction());
