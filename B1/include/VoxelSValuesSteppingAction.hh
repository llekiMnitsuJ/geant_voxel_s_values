...
// $Id$
//
/// \file VoxelSValuesSteppingAction.hh
/// \brief Definition of the VoxelSValuesSteppingAction class

#ifndef VoxelSValuesSteppingAction_h
#define VoxelSValuesSteppingAction_h 1
...
class VoxelSValuesSteppingAction : public G4UserSteppingAction
{
  public:
    VoxelSValuesSteppingAction();
    virtual ~VoxelSValuesSteppingAction();

    // static access method
    static VoxelSValuesSteppingAction* Instance();
  ...
  private:
    static VoxelSValuesSteppingAction* fgInstance;  
