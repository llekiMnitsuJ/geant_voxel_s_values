...
// $Id$
//
/// \file VoxelSValuesEventAction.hh
/// \brief Definition of the VoxelSValuesEventAction class

#ifndef VoxelSValuesEventAction_h
#define VoxelSValuesEventAction_h 1

#include "G4UserEventAction.hh"
#include "globals.hh"

class VoxelSValuesSteppingAction;
...
class VoxelSValuesEventAction : public G4UserEventAction
{
  public:
    VoxelSValuesEventAction();
    virtual ~VoxelSValuesEventAction();
    
    // static access method
    static VoxelSValuesEventAction* Instance();
  ...
  private:
    static VoxelSValuesEventAction* fgInstance;  
